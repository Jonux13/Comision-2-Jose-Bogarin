      ...
      const postWithUserInfo = await Promise.all(
        postDataArray.map(async (postData) => {
          ...
          if (userResponse.ok) {
            ...
            return {
              ...postData,
              autorId: userData._id,
              autor: userData.username,
              avatar: userData.avatar,
            };
          } else {
            console.error(
              `Error al obtener información del usuario ${postData.autor}`
            );
            return postData;
          }
        })
      ...
      {postlists.map((postData) => {
        ...
        return (
          <PostCard
            ...
            imageURL={
              postData.imageURL ||
              "https://www.buenas-vibras.com.ar/uploads/testimonios/16/vicky-min_186x186.png"
            }
